/*Primeiro eu tinha feito esse codigo e nao rodou
let multiplicador = 9
let i= 1
while (i<= n) {
    let resultado= multiplicador * i
    let textoExibido = `${multiplicador} X ${i} = ${resultado}`
    console.log(textoExibido)
}
Entao olhei a resulacao e deu erro. 
Antes de olhar os comentário eu mudei da Resolucao inserindo i++ e deu certo!*/
...
/* Peguei da Resolucao Mas nao deu certo o codigo abaixo. 
DICA LEGAL:
